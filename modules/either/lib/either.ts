...
import { Functor, Foldable, HKT } from '@yafu/fantasy-types'

// eslint-disable-next-line no-use-before-define
export const eitherOf = <L, R> (v: R): Either<L, R> => new Right(v)
...
interface EitherHKT<L> extends HKT {
    output: Either<L, this["input"]>;
}

export default abstract class Either<L, R> implements Functor<R>, Foldable<R> {
  static [OF] = eitherOf
